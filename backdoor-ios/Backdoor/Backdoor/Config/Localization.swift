...
private let enStrings: [String: String] = [
    ...
    "add_category_hint": "Type a name for a new task category. Will be stored with this task and appear in future dropdowns.",
...
private let jaStrings: [String: String] = [
    ...
    "add_category_hint": "新しいカテゴリ名を入力してください。このタスクに保存され、今後のドロップダウンに表示されます。",
