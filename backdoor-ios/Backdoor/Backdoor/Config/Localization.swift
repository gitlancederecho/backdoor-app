...
private let enStrings: [String: String] = [
    ...
    "color": "Color",
    "no_folders": "No folders yet. Create one to organize your tasks.",
    "no_tasks_in_folder": "No tasks in this folder.",
    "tasks_count": "%d tasks",
    "delete_folder_confirm": "Delete folder?",
    "delete_folder_message": "Tasks in this folder move back to Unfiled.",
    "delete_folder_empty_message": "This folder is empty.",
    "delete_folder_choice_message": "%d tasks are in this folder. Choose what to do with them.",
    "delete_folder_and_n_tasks": "Delete folder and %d tasks",
    "delete_folder_keep_tasks": "Keep tasks (move to Unfiled)",
    "select_all": "Select all",
    "deselect_all": "Deselect all",
    "deleted_tasks": "Deleted tasks",
    "no_deleted_tasks": "Nothing in the trash.",
    "restore": "Restore",
    "show_deleted": "Show deleted",
    "created_by_meta": "Created by %@ · %@",
...
private let jaStrings: [String: String] = [
    ...
    "folder_name": "フォルダ名",
    "folder_description": "説明",
    "color": "色",
    "no_folders": "フォルダはまだありません。作成してタスクを整理しましょう。",
    "no_tasks_in_folder": "このフォルダにはタスクがありません。",
    "tasks_count": "%d件のタスク",
    "delete_folder_confirm": "フォルダを削除しますか？",
    "delete_folder_message": "このフォルダ内のタスクは未分類に戻ります。",
    "delete_folder_empty_message": "このフォルダは空です。",
    "delete_folder_choice_message": "このフォルダには %d 件のタスクがあります。どうしますか？",
    "delete_folder_and_n_tasks": "フォルダと %d 件のタスクを削除",
    "delete_folder_keep_tasks": "タスクを残す（未分類へ移動）",
    "select_all": "全て選択",
    "deselect_all": "選択解除",
    "deleted_tasks": "削除済みタスク",
    "no_deleted_tasks": "ゴミ箱は空です。",
    "restore": "復元",
